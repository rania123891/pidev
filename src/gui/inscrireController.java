...
public class inscrireController implements Initializable {
  ...
  // public static final String ACCOUNT_SID = System.getenv("AC0f319b41631d9977d8624e835988aa65");
   //public static final String AUTH_TOKEN = "b47099039dfbe51b562406bc0996fbf4";
...
prof.getItems().addAll(nomsCategories);
   ...
   /* private void get_id(InputMethodEvent event) {
    ...
    Utilisateur u = new Utilisateur(Integer.parseInt(num_field.getText()),nom_field.getText(),prenom_field.getText(),adresse_field.getText(),"user",mdp_field.getText());
     ...
     // Twilio.init("AC0f319b41631d9977d8624e835988aa65","b47099039dfbe51b562406bc0996fbf4");

      //Message.creator(new PhoneNumber("+21692627353"),
                                  // new PhoneNumber("+12762861931"),
                               //    "Bienvenue chez VROOMVROOM")
                           //.create();
      ...
      alert.show();
        ...
        agence f1 = new agence(1,Integer.parseInt(num_field.getText()), nom_field.getText(), prenom_field.getText(),  adresse_field.getText(), "agence", imagePath, description, 0, prof.getValue().toString(), false,mdp_field.getText());
           fs.ajouter(f1);
               ...
               /* Twilio.init("AC0f319b41631d9977d8624e835988aa65","b47099039dfbe51b562406bc0996fbf4");
                ...
                Message.creator(new PhoneNumber("+21692627353"),
                                new PhoneNumber("+12762861931"),
                                "Votre agence a étais ajouté a notre platforme VromVrom")
                        .create();*/
